...
First some storages were built which will later be filled with outcomes from the regressions. 
```{r}
# Group A suffix = .A 
...
Now, a loop is created. It conducts a regression von HR vs time and repeats this for each participant. During this loop, each regression model is stored in "models.A", while each slope is stored in "slopes.A" and the r-squared is stored in "r.sqrds.A". 
```{r}
